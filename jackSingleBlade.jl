...
bulkDataSavePath = "/home/aero/Desktop/tempVPMFilesKeana/jack/V$airSpeed/"*caseName
...
################################################################
## Case description
fidelityLevel = "Mid"  # Low, Mid, High

includeViscous = "ParticleStrengthExchange" # "Inviscid", "CoreSpreading", "ParticleStrengthExchange"
...
domainLimits = 3.0^2 #simulation domain radius

gammaCrit = 0.0003^2  #minimum vorticity

gammaCritup = 13.0^2 #maximum vorticity

wakeTreatmentStep = 40 #wake treatment interval
...
RPMref = 2500.0                                # Reference RPM to scale maneuver by
################################################################
...
bladeFile      = ["jack_blade.csv"]       # Blade geometry
